...
class Signup(Resource):
    def post(self):
        ...
        if res:
            ...
            query("INSERT INTO account VALUES('{0}', '{1}', '{2}', '{3}', '{4}', CURDATE(), 0, null)".format(email, _id, pw, nickname, gender))
            return '', 201
    ...
    def post(self):
        ...
        if request.form['sns'].upper() == 'TRUE':
            ...
            if not query("SELECT * FROM account_sns WHERE email='{0}'".format(email)):
                ...
                query("INSERT INTO account_sns VALUES('{0}', '{1}', '{2}', CURDATE(), 0, null)".format(email, nickname, gender))
